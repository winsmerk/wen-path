...
function Finance({ records,bills, actions, busy, mutate }: { records: FinancialRecord[];bills:FinancialMonthlyBill[]; actions: Action[]; busy: boolean; mutate: (payload: Record<string, unknown>, success?: string) => Promise<boolean> }) {
