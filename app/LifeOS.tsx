...
type JourneyTask = { id:string;journey_id:string;title:string;acceptance_criteria:string;estimated_minutes:number;task_type:"reading"|"finance"|"exercise"|"english"|"account_operation"|"general";execution_frequency:"weekly"|"monthly";priority:number;status:"pending"|"completed";source:"manual"|"ai";completed_at:string|null };
